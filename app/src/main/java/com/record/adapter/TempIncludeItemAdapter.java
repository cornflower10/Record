...
public class TempIncludeItemAdapter extends BaseQuickAdapter<LawCase,BaseViewHolder> {


    public TempIncludeItemAdapter(@LayoutRes int layoutResId, @Nullable List<LawCase> data) {
